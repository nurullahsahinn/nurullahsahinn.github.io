  ...
  if (isFileProtocol) {
    ...
    const translations = {
      'tr': {
        ...
        "about.bap": "TEKNOFEST 2025 kapsamında otonom sualtı araçlarının konfigürasyonuna yönelik geliştirdiğimiz proje, Atatürk Üniversitesi Bilimsel Araştırma Projeleri (BAP) desteği almaya hak kazandı. Projede araştırmacı olarak görev almaktayım. Bu destek, birçok teknik alanda ilerlememize katkı sağlayacak.",
      ...
      'en': {
        ...
        "about.bap": "Our project focused on the configuration of autonomous underwater vehicles for TEKNOFEST 2025 has been awarded support from Atatürk University Scientific Research Projects (BAP). I serve as a researcher in the project. This support will contribute to our progress in many technical areas.",
