  ...
  if (isFileProtocol) {
    ...
    const translations = {
      'tr': {
        ...
        "about.atugem": "Atatürk Üniversitesi Atugem Teknoloji Kulübünde Model Uydu ve Otonom Sualtı Aracı takımlarının ARGE birimlerinde aktif olarak görev almaktayım.",
        "about.bap": "TEKNOFEST 2025 kapsamında otonom su altı araçlarının konfigürasyonuna yönelik geliştirdiğimiz proje, Atatürk Üniversitesi Bilimsel Araştırma Projeleri (BAP) desteği almaya hak kazandı. Projede araştırmacı olarak görev almaktayım. Bu destek, sistem tasarımı, kontrol algoritmaları ve simülasyon çalışmaları başta olmak üzere birçok teknik alanda ilerlememize katkı sağlayacak.",
      ...
      'en': {
        ...
        "about.atugem": "I am actively involved in the R&D departments of the Model Satellite and Autonomous Underwater Vehicle teams at Atatürk University Atugem Technology Club.",
        "about.bap": "Our project focused on the configuration of autonomous underwater vehicles for TEKNOFEST 2025 has been awarded support from Atatürk University Scientific Research Projects (BAP). I serve as a researcher in the project. This support will contribute to our progress in many technical areas, especially system design, control algorithms, and simulation studies.",
